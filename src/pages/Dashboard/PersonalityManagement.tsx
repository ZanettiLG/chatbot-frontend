  ...
  const handleSubmit = async () => {
    try {
      if (editingPersonality) {
        await dispatch(updatePersonality({ id: editingPersonality.id, data: formData } as UpdatePersonalityData));
        showSuccess('Personalidade atualizada com sucesso!');
      } else {
        await dispatch(createPersonality(formData as CreatePersonalityData));
